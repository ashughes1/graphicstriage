...
function displayQueries()
{
  ...
  var footer = ''
    ...
    + '<iframe src="https://sql.telemetry.mozilla.org/public/dashboards/fxJeePNqsiwOR9PPlST9SVszwwiGBqgmFrCrQ0XC?org_slug=default" width="1100" height="1600" scrolling="no"></iframe>'
    + '</div>';
  $("#body").append(footer);
}
